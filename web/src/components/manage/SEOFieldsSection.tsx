...
export default function SEOFieldsSection({
  ...
  const handleGenerateSEO = async () => {
    ...
    try {
      const response = await fetch('/api/manage/ai/generate-seo', {
        method: 'POST',
        headers: {
      ...
      if (result.success && result.seo) {
        onSeoTitleChange(result.seo.title)
        onSeoDescriptionChange(result.seo.description)
        onSeoKeywordsChange(result.seo.keywords)
      }
    } catch (error) {
