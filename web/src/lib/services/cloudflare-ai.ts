/**
 * Cloudflare AI Service for SEO content generation
 */
...
export class CloudflareAIService {
  ...
  constructor() {
    this.accountId = import.meta.env.CLOUDFLARE_IA_API_ID || ''
    this.apiToken = import.meta.env.CLOUDFLARE_IA_API_TOKEN || ''
